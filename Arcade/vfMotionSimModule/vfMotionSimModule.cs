...
namespace WIGUx.Modules.vfMotionSim
{
    public class vfMotionSimController : MonoBehaviour
    {
        ...
        private Transform BrakelightObject;
        ...
        void Start()
        {
            ...
            InitializeLights();
            InitializeObjects();
            if (brakelight) ToggleLight(brakelight, false);
        ...
        void StartFocusMode()
        {
            ...
            if (cockpitCollider != null && inside)
            {
                ...
                if (playerVRSetup != null)
                {
                    ...
                    logger.Debug("Virtua Racing Motion Sim starting...Wow Chunky polygons!");
                    logger.Debug("Ready, Go!...");
                    isRiding = true; // Set riding state to true
                }
            }
            else
 ...
 isCenteringRotation = false;
        ...
        private void MapButtons(ref bool inputDetected, ref bool throttleDetected) // Pass by reference
        {
            ...
            {
                if (brakelight) ToggleLight(brakelight, true);
 ...
 isCenteringRotation = false;
            ...
            var currentLampStates = new Dictionary<string, int>(StringComparer.OrdinalIgnoreCase)
    {
        ...
        void ProcessLamp0(int state)
        {
            ...
            // Update lights
            if (brakelight) ToggleLight(brakelight, state == 1);
