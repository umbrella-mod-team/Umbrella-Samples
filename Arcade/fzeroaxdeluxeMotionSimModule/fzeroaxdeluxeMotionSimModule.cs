...
namespace WIGUx.Modules.fzeroaxdeluxeMotionSim
{
    public class fzeroaxdeluxeMotionSimController : MonoBehaviour
    {
        ...
        public float primaryThumbstickRotationMultiplier = 50f; // Multiplier for primary thumbstick rotation intensity
        public float secondaryThumbstickRotationMultiplier = 20f; // Multiplier for secondary thumbstick rotation intensity
        public float triggerRotationMultiplier = 30f; // Multiplier for trigger rotation intensity
