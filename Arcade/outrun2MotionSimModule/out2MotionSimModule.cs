        ...
        void StartFocusMode()
        {
            ...
            if (cockpitCollider != null && inside)
            {
                ...
                if (playerVRSetup != null)
                {
                    ...
                    logger.Debug("Outrun 2 Motion Sim starting... Wait why do I have 2 steering wheels?");
                    logger.Debug("What side do I sit om?...");
                    isRiding = false; // Set riding state to false
                }
            }
            else
                ...
                if (YObject != null)
                {
                    ...
                    if (ZObject != null)
                    {
                        ...
                        if (BrakelightsObject != null)
                        {
                            ...
                            {
                                logger.Debug($"{gameObject.name} Renderer component is not found on Brakelights object.");
                            }
                        }
                        else
                        {
                            logger.Debug($"{gameObject.name} Brakelights object not found under Z.");
                        }
                        // Find Wheel under Z
