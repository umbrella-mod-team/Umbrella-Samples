...
namespace WIGUx.Modules.idlimitedMotionSim
{
    public class idlimitedMotionSimController : MonoBehaviour
    {
        ...
        [SerializeField] float minRotationX = -5f;
        [SerializeField] float maxRotationX = 5f;
        [SerializeField] float minRotationY = -30f;
        [SerializeField] float maxRotationY = 30f;
        [SerializeField] float minRotationZ = -3f;
        [SerializeField] float maxRotationZ = 3f;
        ...
        void Start()
        {
            ...
            if (HazardRObject) ToggleEmissive(HazardRObject.gameObject, false);
            if (HazardLObject) ToggleEmissive(HazardLObject.gameObject, false);
        ...
        void StartFocusMode()
        {
            ...
            if (cockpitCollider != null && inside)
            {
                ...
                if (playerVRSetup != null)
                {
                    ...
                    logger.Debug($"{gameObject.name} We Are Running in the 90's...");
                    logger.Debug($"{gameObject.name} GAS GAS GAS!!!...");
                    isRiding = true; // Set riding state to true
                }
            }
            else
        ...
        void EndFocusMode()
        {
            ...
            StartAttractPattern();
            // if (Fire1Object) if (Fire1Object) if (Fire1Object) ToggleEmissive(Fire1Object.gameObject, false);
            // if (Fire2Object) if (Fire2Object) ToggleEmissive(Fire2Object.gameObject, false);
            ResetPositions();
 ...
 isCenteringRotation = false;
            ...
            if (XInput.GetDown(XInput.Button.LIndexTrigger))
            {
                ...
                //  if (StartObject) if (StartObject) ToggleEmissive(StartObject.gameObject, true);
 ...
 isCenteringRotation = false;
            ...
            if (XInput.GetUp(XInput.Button.LIndexTrigger))
            {
                if (brake_light1) ToggleLight(brake_light1, false);
                if (brake_light2) ToggleLight(brake_light2, false);
                //   if (StartObject) if (StartObject) ToggleEmissive(StartObject.gameObject, false);
            ...
            var currentLampStates = new Dictionary<string, int>(StringComparer.OrdinalIgnoreCase)
    {
        ...
        IEnumerator attractPattern()  //Pattern For Attract Mode
        {
			...
			while (true)
            {
                ...
                if (HazardRObject) ToggleEmissive(HazardRObject.gameObject, true);
                if (HazardLObject) ToggleEmissive(HazardLObject.gameObject, true);
            ...
            if (XObject != null)
            {
                ...
                if (YObject != null)
                {
                    ...
                    if (ZObject != null)
                    {
                        ...
                        // Find HazardR object under Z
                        HazardRObject = ZObject.Find("HazardR");
                        if (HazardRObject != null)
                        {
                            logger.Debug($"{gameObject.name} HazardR object found.");
                            // Ensure the HazardR object is initially off
                            Renderer renderer = HazardRObject.GetComponent<Renderer>();
                            if (renderer != null)
                            {
                                renderer.material.DisableKeyword("_EMISSION");
                            }
                        ...
                        {
                            logger.Debug($"{gameObject.name} HazardR object not found.");
                        }
                        // Find HazardL object under Z
                        HazardLObject = ZObject.Find("HazardLObject");
                        if (HazardLObject != null)
                        {
                            logger.Debug($"{gameObject.name} HazardL object found.");
                            // Ensure the HazardL object is initially off
                            Renderer renderer = HazardLObject.GetComponent<Renderer>();
                            if (renderer != null)
                            {
                                renderer.material.DisableKeyword("_EMISSION");
                            }
                        ...
                        {
                            logger.Debug($"{gameObject.name} HazardL object not found.");
                        }
                        ...
                        if (Brakelight1Object != null)
                        {
                            ...
                            // Ensure the Brakelight1Object object is initially off
