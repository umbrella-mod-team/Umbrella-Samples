...
namespace WIGUx.Modules.idMotionSim
{
    public class idMotionSimController : MonoBehaviour
    {
        ...
        void Start()
        {
            ...
            hazzardEmissiveObjects[0] = ZObject.Find("hazardl")?.GetComponent<Renderer>();
            hazzardEmissiveObjects[1] = ZObject.Find("hazardr")?.GetComponent<Renderer>();
            hazzardEmissiveObjects[2] = ZObject.Find("hazard")?.GetComponent<Renderer>();
