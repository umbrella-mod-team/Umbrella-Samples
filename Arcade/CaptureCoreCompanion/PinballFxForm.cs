...
namespace CaptureCoreCompanion
{
    public partial class PinballFxForm : Form
    {
        ...
        public PinballFxForm(string xmlFile, string emuVRPath, string defaultOutputFolder)
        {
            ...
            if (string.IsNullOrWhiteSpace(txtEmulatorPath.Text))
                txtEmulatorPath.Text = Path.GetFullPath(Path.Combine(emuVRPath, @".\Emulators\PinballFX\PinballFX.exe"));
            // Set output folder
            if (string.IsNullOrWhiteSpace(txtOutputFolder.Text))
                txtOutputFolder.Text = Path.GetFullPath(Path.Combine(emuVRPath, @".\Games\PinballFX\"));
        }
