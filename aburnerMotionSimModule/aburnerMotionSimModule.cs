...
//        public Color fireLightColor = Color.red; // Color of the light when it is on
        ...
        private readonly string[] compatibleGames = { "aburner", "After Burner", "After Burner II", "aburner2.zip", "aburner.zip" };
        ...
        public void TurnLightsOn()
        {
            ...
            {
                Debug.LogWarning("firelight1 is not assigned!");
            }
            ...
            {
                Debug.LogWarning("firelight2 is not assigned!");
            }
        }

        // Method to turn the lights off
        public void TurnLightsOff()
        {
            if (fire1_light != null)
            {
                fire1_light.enabled = false;
            }
            else
            {
                Debug.LogWarning("fire1_light is not assigned!");
            }

            if (fire2_light != null)
            {
                fire2_light.enabled = false;
            }
            else
            {
                Debug.LogWarning("fire2_light is not assigned!");
            }
        }
        */
